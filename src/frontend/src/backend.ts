...
export class Backend implements backendInterface {
    ...
    async deleteProjectZip(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteProjectZip();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async downloadProjectZip(): Promise<Uint8Array> {
        if (this.processError) {
            try {
                const result = await this.actor.downloadProjectZip();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadProjectZip(arg0: Uint8Array): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadProjectZip(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
